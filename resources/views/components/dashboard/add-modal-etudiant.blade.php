            ...
            <form method="POST" action="{{ route('etudiants.store') }}" class="p-4 md:p-5">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <select id="filiere" name="filiere_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            ...
                            @foreach ($filieres as $filiere)
                                <option value={{ $filiere->id }}>{{ $filiere->nom }} ({{ $filiere->annee_universitaire }})</option> 
                            @endforeach
                        </select>
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                    ...
                    <div class="col-span-2">
                        ...
                        <input id="lieu_de_naissance" name="lieu_de_naissance" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                    </div>
                </div>
